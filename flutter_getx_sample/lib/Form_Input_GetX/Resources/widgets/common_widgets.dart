...
Widget buttonWidget({@required label, @required colorButton, @required colorText, @required onPress}){
  return GestureDetector(
    child: Container(
      ...
      child: Text(label,style: TextStyle(color: colorText, fontSize: 15),),
    ),
    onTap: onPress,
  );
}